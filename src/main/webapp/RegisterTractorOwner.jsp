			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="RegisterTractorOwner" class="register-form"
							id="register-form">
					...
					<div class="signup-image">
						<figure>
							<img src="images/tractorImg2.jpg" alt="sing up image">
						</figure>
						<a href="LoginTractorOwner.jsp" class="signup-image-link">Go to login page</a>
					</div>
				</div>
			</div>
		</section>
