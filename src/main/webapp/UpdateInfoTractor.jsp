...
<body>
 ...
 <h1 style="margin-left: 400px;color: rgb(99, 99, 135);">Select the Equipments and Accesseries you Currently have</h1>
...
<!-- JS -->
	...
	<link rel="stylesheet" href="alart/disk/sweetalert.css">
		...
		function Fun(){
			swal("congrats","Your updation has been received ,Thanks for choosing TBS","success");
		    }
		
		
		var status ="success";
		if(status == "success"){
			swal("Update the Equipments you have");
		}</script>
</body>
</html>